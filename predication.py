...
background_image_url = "https://www.ltts.com/sites/default/files/styles/ltts_blog_image/public/blogs/2024-05/AI-medical-diagnostics.jpg?itok=NkbGF407"  # Replace with your image URL
...
models = {
    'diabetes': pickle.load(open("c:\\Users\\itsme\\Downloads\\models\\diabetes.sav", 'rb')),
    'heart_disease': pickle.load(open("C:\\Users\\itsme\\Downloads\\models\\heart_disease_model_my_way.sav", 'rb')),
    'parkinsons': pickle.load(open("C:\\Users\\itsme\\Downloads\\models\\parkinsons_detection.sav", 'rb')),
    'lung_cancer': pickle.load(open("C:\\Users\\itsme\\Downloads\\models\\lungs_cancer_model.sav", 'rb')),
    'thyroid': pickle.load(open("C:\\Users\\itsme\\Downloads\\models\\hyperthroid.sav", 'rb'))
}
